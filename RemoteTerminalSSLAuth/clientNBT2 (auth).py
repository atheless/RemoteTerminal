...
def authenticate_user(client_socket):
    ...
    # Combine the username and password into a message to send to the server
    credentials = f"{username}:{password}"

    # Send the credentials to the server for authentication
    send_message(client_socket, credentials)
...
def client_program():
    ...
    try:
        ...
        # Authenticate the user before starting other threads
